...
// add goods
router.post('/catalog/add', checkMiddleware, goodsController.create)
...
// change one of goods
router.put('/catalog', checkMiddleware, goodsController.change)

// delete one of goods by id
router.delete('/catalog/:id', checkMiddleware, goodsController.delete)
